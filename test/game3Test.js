...
describe("Game3", function () {
  async function deployContractAndSetVariables() {
    ...
    const add1 = await signer1.getAddress();
    const add2 = await signer2.getAddress();
    const add3 = await signer3.getAddress();

    return { game, signer1, signer2, signer3, add1, add2, add3 };
  }

  it("should be a winner", async function () {
    const { game, signer1, signer2, signer3, add1, add2, add3 } =
